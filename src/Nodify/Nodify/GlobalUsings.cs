...
// VENDORED, diverges from upstream v6.6.0 (src/Nodify/README.md). Two changes:
//  - the second `global using Avalonia.Interactivity;` above is gone (CS0105, duplicate of line 5).
//  - Avalonia 12 renamed GotFocusEventArgs to FocusChangedEventArgs. Aliasing is how the rest of
//    this file already absorbs renames, and it leaves the two Compatibility/Commands files that
//    name the type byte-identical to upstream.
global using GotFocusEventArgs = Avalonia.Input.FocusChangedEventArgs;