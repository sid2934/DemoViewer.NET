...
{
    // VENDORED, diverges from upstream v6.6.0 (src/Nodify/README.md): the two optional parameters
    // below defaulted to null while typed non-nullable, which is CS8625 and an error under this
    // repository's TreatWarningsAsErrors. The bodies already null-check them.
