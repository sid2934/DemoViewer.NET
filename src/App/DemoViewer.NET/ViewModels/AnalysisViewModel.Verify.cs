...
public sealed partial class AnalysisViewModel
{
    ...
    ///     "enable Live Sync first" prompt: CS2 is never auto-launched from here.
    /// </summary>
    ...
    ///     mid-seek) it surfaces an inline note that the seek failed; the shell chip is the primary failure surface.
    /// </summary>
