...
**Signed off.** The label change is an improvement (ink-centred text is centred; box-centred text is
centred on a box with descender space the string may not use), and the typeface change is a
