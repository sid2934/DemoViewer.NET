...
| `.chip` | Button, ToggleButton | Compact toolbar size (FontSize 11 / Padding 8 3); **keeps Fluent chrome/color**. | — (size only) | `primitives` |
...
| `.shell-tab` | TabItem | On-theme monospace tab header (mirrors MainView's local tab look, for module/sub-tab bars). | — (mono/size) | `primitives` |
