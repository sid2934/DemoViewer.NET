...
/// <param name="Name">Player name at the sample point: logging and verification only, not encoded.</param>
...
internal static class TeamEventSynthesizer
{
    ...
    ///     synthesis is then skipped, since inventing a descriptor would desync from the real schema).
